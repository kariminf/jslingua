let AraMorpho = import("../../src/ara/ara.AraMorpho");
...
describe("Arabic Verb conjugation", function(){
  ...
  it("Sahih Salim (standard) past", function() {
    ...
    expect(AraAraMorpho.conj("ذهب",$({}, pa, he))).to.eql("ذَهبَ");
    expect(AraAraMorpho.conj("ذهب",$({}, pa, she))).to.eql("ذَهبَتْ");
    expect(AraAraMorpho.conj("ذهب",$({}, pa, theymd))).to.eql("ذَهبَا");
    expect(AraAraMorpho.conj("ذهب",$({}, pa, theyfd))).to.eql("ذَهبَتَا");
    expect(AraAraMorpho.conj("ذهب",$({}, pa, theymp))).to.eql("ذَهبُوا");
    expect(AraAraMorpho.conj("ذهب",$({}, pa, theyfp))).to.eql("ذَهبْنَ");
