...
AraTrans._nTrans("buckwalter", arabic, buckwalter);
AraTrans._nTrans("arabtex", arabic, arabtex);
AraTrans._nTrans("morse", arabic, armorse);
AraTrans._sTransCnd("morse", __morsePreTrans, __morsePostTrans);
AraTrans._sUntransCnd("morse", __morsePreUntrans, __morsePostUntrans);

export default AraTrans;
